...
{
	public class AwInstitutionSpecialityNomenclatureDto : IActionWorkflowOperation
	{
		...
		public string ExcelText => "Изтегляне на excel - номенклатури специалности/докторски програми";
	}
}
