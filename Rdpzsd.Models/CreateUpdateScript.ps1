...
dotnet ef --startup-project ../Server/ migrations add $version --context RdpzsdDbContext

dotnet ef --startup-project ../Server/ migrations script $fromVersion --no-transactions --context RdpzsdDbContext --output "../Database/Update/$($version).sql"
